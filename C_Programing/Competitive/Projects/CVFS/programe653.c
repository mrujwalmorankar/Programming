...
void DisplayHelp()
{
    ...
    printf("backup : It is used to take backup of all files\n");
...
void ManPageDisplay(char Name[])
{
    ...
    {
        printf("About : It is used to take backup of all files\n");
        printf("Usage : backup\n");
    }
    else
    {
...
)
{
    ...
    for(i = 0; i < MAXOPENFILES; i++)
    {
        if(uareaobj.UFDT[i] != NULL)
        {
            if(strcmp(uareaobj.UFDT[i]->ptrinode->FileName,
                      name) == 0)
            {
...
void Backup()
{
    ...
    printf("Backup gets created succesfully\n");
    printf("Backup File Name : CVFS_Backup.txt\n");
}

//////////////////////////////////////////////////////
//
//  Function Name :     DeallocateResources()
//  Description :       It is used to deallocate all
//                      allocated resources
//  Author :            Ujwal Dipak Morankar
//  Date :              8/08/2026
//
...
void DeallocateResources()
{
    ...
    // Deallocate UFDT and file buffers

    for(i = 0; i < MAXOPENFILES; i++)
    {
        if(uareaobj.UFDT[i] != NULL)
        {
            if(uareaobj.UFDT[i]->ptrinode != NULL)
            {
    ...
    printf("All resources gets deallocated successfully\n");
}
