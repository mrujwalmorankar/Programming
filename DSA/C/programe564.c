...
//jya node chya left right  node mdhe null ahe tyaana leaf node mhntat 
...
//Seaching mdhe 3 types ahet
//--linear Search
//--Bidirectional search
//--Binary Search--In this your data be sorted..otherwise not worked 
