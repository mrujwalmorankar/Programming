    ...
    public static void main(String A[] )
     {
         ...
         iRet=dobj.CountoddEvenDigits(iValue);//Function call with class object or riakami pishvi

         System.out.println("Number of odd Digits are :"+iRet);     //counting logic           
    }
}
class DigitX
{
  public int CountoddEvenDigits(int iNo)
  {
    int iDigit=0;
    int iCount=0;
    int  ///counting logic
